...
namespace TextRPG
{
    ...
    internal class Program
    {
        ...
        static void GameDataSetting()
        {
            ...
            // 아이템 정보 세팅
            item[0] = new Item("무쇠갑옷","", "방어력", 5, "무쇠로 만들어져 튼튼한 갑옷입니다.", false);
            item_count++;
            item[1] = new Item("낡은 검", "" , "공격력", 2, "쉽게 볼 수 있는 낡은 검 입니다.", false);
            item_count++;
        ...
        static void DisplayMyInfo()
        {
            ...
            Console.WriteLine($"공격력 :{player.Atk+Atk_sum}   (+{Atk_sum})");
            Console.WriteLine($"방어력 : {player.Def+Def_sum}  (+{Def_sum})");
        ...
        static void DisplayShop()
        {
            ...
            {
                Console.WriteLine($"- {shop[i].Name}    {shop[i].Stat} +{shop[i].Add_stat}    {shop[i].Ex}    {shop[i].Price}{shop[i].Buy_comple}");
            }
            Console.WriteLine();
        ...
        static void ShopManager()
        {
            ...
            int shop_select = int.Parse(Console.ReadLine()) - 1;
            if (player.Gold > shop[shop_select].Price)
            {
                ...
                for (int i = 0; i < item_count; i++)
                {
                    if (item[i].Name == shop[shop_select].Name)
                    {
                        shop[shop_select].Display_buy = true;
                        shop[shop_select].Price = 0;
                        shop[shop_select].Buy_comple = "구매완료";
                    }
                }
            }
